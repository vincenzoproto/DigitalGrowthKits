...
export const metadata = createPageMetadata({"path": "/terms", "title": "Implementation terms | GuestFlow Systems", "description": "GuestFlow implementation scope, customer responsibilities, third-party services and optional managed support."});
