...
export const metadata = createPageMetadata({"path": "/privacy", "title": "Privacy information | GuestFlow Systems", "description": "How GuestFlow Systems uses information you provide when requesting a hotel automation setup or implementation review."});
  ...
  return (
    <main style={{maxWidth:900,margin:"0 auto",padding:"72px 22px 110px"}}>
      ...
      <section style={{display:"grid",gap:28,marginTop:48}}>
        ...
        <div><h2>Partner referrals</h2><p>If you follow a partner link, a first-party session cookie stores its referral code while you navigate this site. The code may accompany your enquiry and Stripe checkout so we can reconcile the referral. This cookie contains no guest records or payment details.</p></div>
