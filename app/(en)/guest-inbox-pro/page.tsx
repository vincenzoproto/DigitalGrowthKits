...
export const metadata = createPageMetadata({
  path: "/guest-inbox-pro",
  title: "Shared Guest Inbox for Hotels & B&Bs | Guest Inbox Pro",
  description: "Organise hotel guest messages, booking enquiries and check-in questions in one shared inbox. Supported channels, routing and staff handover configured for you.",
});
    ...
    <main className={styles.shell}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroCopy}>
          ...
          <h1>Guest messages.<br/>One inbox for your hotel team.</h1>
          ...
          <div className={styles.actions}>
            ...
            <Link className={styles.secondary} href="/guest-inbox-pro/demo">Explore the inbox demo</Link>
          </div>
        </div>
      ...
      <section className={styles.section}>
        ...
        <h2>A shared workflow for guest messages.</h2>
      ...
      <section className={styles.section}>
        <span className={styles.eyebrow}>Before setup</span>
        <h2>What your team needs to get started.</h2>
        <div className={styles.grid3}>
          <div className={styles.mini}><strong>What you provide</strong><span className={styles.muted}>Your channel list, staff roles, common guest questions and a contact who can approve connections. We agree how to share access during implementation.</span></div>
          <div className={styles.mini}><strong>What you receive</strong><span className={styles.muted}>A configured inbox for one property, connected supported channels, team access, labels, assignment rules and staff operating guidance.</span></div>
          <div className={styles.mini}><strong>When to choose another service</strong><span className={styles.muted}>This package does not include outsourced reception staff answering guests for you. Channel compatibility is checked before setup; connections and provider fees vary.</span></div>
        </div>
        <div className={styles.actions}><Link className={styles.primary} href="/request-setup?product=guest-inbox-pro">Check my channels</Link><Link className={styles.secondary} href="/audit">Start with the free hotel audit</Link></div>
      </section>
    </main>
  );
}
