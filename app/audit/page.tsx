...
export const metadata: Metadata = {
  ...
  description: "A free 2-minute audit to assess whether your hotel or B&B is ready to reactivate past guests and build a repeat-booking workflow.",
  alternates: { canonical: "/audit", languages: { en: "/audit", it: "/it/audit" } },
};
...
export default function AuditPage(){
  return <main className="audit-page">
    ...
    <section id="audit" className="audit-section"><AuditCalculator/></section>
