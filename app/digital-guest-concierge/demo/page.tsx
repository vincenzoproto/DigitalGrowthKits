...
export const metadata: Metadata = {
  title: "Digital Guest Concierge Demo | GuestFlow Systems",
  description: "Preview a mobile-first guest portal for stay information, services and guest upsells.",
  alternates: { canonical: "/digital-guest-concierge/demo" },
};
