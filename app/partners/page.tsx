...
export const metadata: Metadata = {
  title: "GuestFlow Partner Network",
  description: "Partner with GuestFlow Systems to introduce qualified hospitality clients that need guest retention, messaging, concierge or direct-booking systems.",
};
