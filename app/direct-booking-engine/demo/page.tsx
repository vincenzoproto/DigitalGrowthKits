...
export const metadata: Metadata = {
  title: "Direct Booking Engine Demo | GuestFlow Systems",
  description: "Preview a direct hotel booking journey with rooms, rates and a clear reservation path.",
  alternates: { canonical: "/direct-booking-engine/demo" },
};
