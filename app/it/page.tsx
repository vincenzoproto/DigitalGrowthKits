...
const systems = [
  { href: "/it/guest-inbox-pro", area: "Operazioni ospiti", title: "Riduci i messaggi ripetitivi", product: "Guest Inbox Pro", price: "€690" },
  { href: "/it/repeat-guest-engine", area: "Retention", title: "Genera più prenotazioni di ritorno", product: "Repeat Guest Engine", price: "€990" },
  { href: "/it/digital-guest-concierge", area: "Esperienza ospite", title: "Rendi le informazioni del soggiorno più accessibili", product: "Digital Guest Concierge", price: "€490" },
  { href: "/it/direct-booking-engine", area: "Ricavi diretti", title: "Costruisci un percorso di prenotazione diretta più chiaro", product: "Direct Booking Engine", price: "€1.490" },
];
