...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    "", "/guest-inbox-pro", "/guest-inbox-pro/demo", "/digital-guest-concierge", "/digital-guest-concierge/demo", "/repeat-guest-engine", "/repeat-guest-engine/demo", "/repeat-guest-engine/founder", "/direct-booking-engine", "/direct-booking-engine/demo", "/request-setup", "/partners", "/privacy", "/terms",
