...
export default function RepeatGuestEnginePage() {
  return (
    <main className={styles.shell}>
      <section className={styles.hero}>
        <div>
          ...
          <div className={styles.actions}>
            ...
            <Link className={styles.secondary} href="/request-setup?product=repeat-guest-engine">Book a 15-min setup review</Link>
          </div>
      ...
      <section className={styles.section}>
        <span className={styles.eyebrow}>Data responsibility</span><h2>Guest history is not a spam list.</h2>
